...
public enum ErrorCode {
    ...
    INVALID_TERMS_COMBINATION(HttpStatus.CONFLICT),
    NO_TARGET_TERM(HttpStatus.CONFLICT),
    SUPPLIER_NOT_READY_FOR_VALIDATION(HttpStatus.CONFLICT),
    ...
    CONSIGNMENT_IN_REWORK_HOLD(HttpStatus.CONFLICT),
    CONSIGNMENT_INSPECTION_PENDING(HttpStatus.CONFLICT),
    PROVISIONAL_GRN_EXISTS(HttpStatus.CONFLICT),
    PROVISIONAL_GRN_NOT_AMENDABLE(HttpStatus.CONFLICT),
    CONSIGNMENT_NOT_ARRIVAL_ELIGIBLE(HttpStatus.CONFLICT),
    ARRIVAL_ALREADY_CONFIRMED(HttpStatus.CONFLICT),
    ARRIVAL_NOT_CONFIRMED(HttpStatus.CONFLICT),
    ETD_NOT_SETTABLE_AFTER_ARRIVAL(HttpStatus.CONFLICT),
    CONTAINER_FILL_OFFER_AFTER_ARRIVAL(HttpStatus.CONFLICT),
    CONTAINER_FILL_OFFER_NOT_CANCELLABLE(HttpStatus.CONFLICT),
    CONTAINER_FILL_DEADLINE_IN_PAST(HttpStatus.CONFLICT),
    CONTAINER_FILL_DEADLINE_NOT_SETTABLE(HttpStatus.CONFLICT),
    CONTAINER_FILL_OFFER_NOT_DECIDABLE(HttpStatus.CONFLICT),
    CONTAINER_FILL_OFFER_NOT_CONFIRMED(HttpStatus.CONFLICT),
    ...
    PAYMENT_NOT_PAYABLE(HttpStatus.CONFLICT),
    PAYMENT_NOT_HOLDABLE(HttpStatus.CONFLICT),
    PAYMENT_NOT_ON_HOLD(HttpStatus.CONFLICT),
