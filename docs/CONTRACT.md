...
> **⚠️ Before Feature 6 — a scoping decision to settle first (Roadmap v2, for the user + Danny):** Feature 6 as originally scoped was the three-way match; Roadmap v2 rewrote it as the three-way match **plus** freight invoice reconciliation **plus** NCR true-cost and dispute-letter generation — roughly one feature vs three, materially changing the timeline. Worth resolving before breaking Feature 6 down, not mid-build.
