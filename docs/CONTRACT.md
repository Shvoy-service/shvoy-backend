...
| Ex-factory date (the `EX_FACTORY` anchor) | `LocalDate` | Model in place — Story 7.1, `Shipment#exFactoryDate` (publish is 7.2) |
| BL date (the `BL` anchor) | `LocalDate` | Model in place — Story 7.1, `Shipment#blDate` (publish is 7.2) |
