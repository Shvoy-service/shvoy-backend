...
- [ ] **Configure sign-up experience**:
  - Self-registration: doesn't matter either way — our app never uses Cognito's own public sign-up (`SignUp`/`ConfirmSignUp`), only `AdminCreateUser`. Leave the default.
